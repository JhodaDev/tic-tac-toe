      ...
      <div className="absolute w-full h-screen bg-modal flex justify-center items-center top-0 left-0">
        <div className="modal">
          ...
          <div className="flex mt-6">
            <button className="bg-primaryButton px-4 py-2 rounded-lg font-bold text-slate-700 mr-5">
              QUIT
            </button>
            <button
              className={`px-4 py-2 rounded-lg font-bold text-slate-700 ${
                turn === 1 ? 'bg-blue' : 'bg-yellow'
              }`}
              onClick={handleReset}
            >
              NEXT ROUND
